...
export default function StoryCard({ story, onReuse }) {
  ...
  return (
    <div className="flex items-center flex-wrap gap-x-4 gap-y-2.5 px-4 py-3.5 mb-2.5 bg-[var(--surface)] border border-[var(--line)] rounded-xl transition hover:border-[var(--line-strong)] hover:shadow-[0_4px_16px_-10px_rgba(40,30,15,0.22)]">
      <div
      ...
      <div className="min-w-0 flex-1">
        <div className="font-news font-semibold text-[15.5px] tracking-tight truncate">{r.t}</div>
      ...
      <div className="flex gap-1.5 shrink-0 basis-full sm:basis-auto sm:ml-auto justify-end">
